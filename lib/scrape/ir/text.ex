defmodule Scrape.IR.Text do
  ...
  clustering. Details are hidden within the algorithms, so a clean interface
  can be provided.
  """
  ...
  @doc """
  Find out in which natural language the given text is written in. Currently,
  only german and (fallback) english are valid results. Uses external library
  [Paasaa](https://hex.pm/packages/paasaa).
